/*
    ...
    * 3º passo: desenvolver funções que realizam os cálculo;
    * 4º passo: atualizar a interface.
*/
...
function removerDespesa(evento) {
    const despesaClicada = evento.target.parentNode; // parentNode pega o elemento pai do elemento atual
